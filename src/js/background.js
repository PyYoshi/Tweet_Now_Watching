...
var DelayAccessSecond, ShowNotificationSecond, TwitterHtml, addContextMenus, checkHtml, createContextMenus, fetchTwitterWeb, getUserLatestPost, isLogin, popupWindow, renderBadge, tw, updateStatus;
...
getUserLatestPost = function(screenName, call) {};
...
updateStatus = function(msg) {
  var ntf_id, ntf_opts, ntf_title_done, ntf_title_error, ntf_title_posting;
  if (msg == null) {
    msg = null;
  }
  ntf_id = 0;
  ...
  return tw.update(msg, function(jqXHR, settings) {
    var ntf_opts_posting;
    ntf_opts_posting = ntf_opts;
    ntf_opts_posting['title'] = ntf_title_posting;
    chrome.notifications.create(ntf_id, ntf_opts_posting, function() {});
    ...
    chrome.notifications.update(ntf_id, ntf_opts_done, function() {});
    setTimeout(function() {
      chrome.notifications.clear(ntf_id, function() {});
